...
using Keboo.Web.Proxy.StreamExtended.Models;

namespace Keboo.Web.Proxy.StreamExtended;
...
#pragma warning restore 618
    ...
    public override string ToString()
    {
        ...
        sb.AppendLine(
            $"A SSLv{HandshakeVersion}-compatible ClientHello handshake was found. Keboo extracted the parameters below.");
        sb.AppendLine();
